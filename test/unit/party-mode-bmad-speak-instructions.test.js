...
describe('party mode TTS instructions', () => {
  it('uses the cross-platform bmad-speak entry point in the packaged workflow steps', async () => {
    const discussionStep = await readProjectFile('_bmad/core/bmad-party-mode/steps/step-02-discussion-orchestration.md');
    const exitStep = await readProjectFile('_bmad/core/bmad-party-mode/steps/step-03-graceful-exit.md');
